...
import { deployCached } from '../scripts/deploy';
import { initClient } from '../scripts/client';
import { createAccount } from '../scripts/createAccount';
import { verifyEcrecover } from '../scripts/verifyEcrecover';
import { formatPrivateKey } from '../utils/formatPrivateKey';
import { changeAccountKeys } from '../scripts/updateAccount';

const testEcrecover = async (initialKey: string, withAlias: boolean, changedTo: string) => {
